...
const (
	CommunicationService_SendEmail_FullMethodName = "/communication.v1.CommunicationService/SendEmail"
)
...
func (c *communicationServiceClient) SendEmail(ctx context.Context, in *SendEmailRequest, opts ...grpc.CallOption) (*SendEmailResponse, error) {
...
func (UnimplementedCommunicationServiceServer) SendEmail(context.Context, *SendEmailRequest) (*SendEmailResponse, error) {
...
func _CommunicationService_SendEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommunicationServiceServer).SendEmail(ctx, req.(*SendEmailRequest))
	}
